...
int main(){
  std::string cont;
  std::cout << "Welcome to 'Can You Cook Cheap?' This is a small, snarky adventure in the kitchen to try and make something simple without screwing up, or screwing up on purpose to see what happens. To begin, press any key and then press 'Enter'.\n\n";
  std::cin >> cont;
  std::cout << "\n\n";
